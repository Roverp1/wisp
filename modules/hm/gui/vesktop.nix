{
  ...
  cfg = config.wisp.vesktop;
in {
  options.wisp.vesktop = {
    enable = lib.mkOption {
      type = lib.types.bool;
          ...
          in
            ...
            ''
              ...
              */
              ...
              body {
                /* font, change to x' for default discord font */
                --font: "DM Mono"; /* change to x' for default discord font */
                --code-font: "DM Mono"; /* change to x' for default discord font */
              ...
              :root {
                ...
                --text-2: ${c.base0D}; /* headings and important text */
                ...
                --bg-1: color-mix(in srgb, ${c.base03} 85%, transparent); /* dark buttons when clicked */
                --bg-2: color-mix(in srgb, ${c.base02} 85%, transparent); /* dark buttons */
                --bg-3: color-mix(in srgb, ${c.base01} 85%, transparent); /* spacing, secondary elements */
                --bg-4: color-mix(in srgb, ${c.base00} 85%, transparent); /* main background color */

                --hover: color-mix(in srgb, ${c.base05} 10%, transparent); /* channels and buttons when hovered */
                --active: color-mix(in srgb, ${c.base05} 20%, transparent); /* channels and buttons when clicked or selected */
                --active-2: color-mix(in srgb, ${c.base05} 30%, transparent); /* extra state for transparent buttons */
                ...
                --button-border: color-mix(in srgb, ${c.base05} 10%, transparent); /* neutral border color of buttons */

                /* base colors */
                --red-1: color-mix(in srgb, ${c.base08} 85%, #ffffff);
                --red-2: ${c.base08};
                --red-3: color-mix(in srgb, ${c.base08} 85%, #000000);
                --red-4: color-mix(in srgb, ${c.base08} 70%, #000000);
                --red-5: color-mix(in srgb, ${c.base08} 55%, #000000);

                --green-1: color-mix(in srgb, ${c.base0B} 85%, #ffffff);
                --green-2: ${c.base0B};
                --green-3: color-mix(in srgb, ${c.base0B} 85%, #000000);
                --green-4: color-mix(in srgb, ${c.base0B} 70%, #000000);
                --green-5: color-mix(in srgb, ${c.base0B} 55%, #000000);

                --blue-1: color-mix(in srgb, ${c.base0D} 85%, #ffffff);
                --blue-2: ${c.base0D};
                --blue-3: color-mix(in srgb, ${c.base0D} 85%, #000000);
                --blue-4: color-mix(in srgb, ${c.base0D} 70%, #000000);
                --blue-5: color-mix(in srgb, ${c.base0D} 55%, #000000);

                --yellow-1: color-mix(in srgb, ${c.base0A} 85%, #ffffff);
                --yellow-2: ${c.base0A};
                --yellow-3: color-mix(in srgb, ${c.base0A} 85%, #000000);
                --yellow-4: color-mix(in srgb, ${c.base0A} 70%, #000000);
                --yellow-5: color-mix(in srgb, ${c.base0A} 55%, #000000);

                --purple-1: color-mix(in srgb, ${c.base0E} 85%, #ffffff);
                --purple-2: ${c.base0E};
                --purple-3: color-mix(in srgb, ${c.base0E} 85%, #000000);
                --purple-4: color-mix(in srgb, ${c.base0E} 70%, #000000);
                --purple-5: color-mix(in srgb, ${c.base0E} 55%, #000000);
              }
            '';
        };
      };
